  ...
  if (total_power > kMinEnergy) {
    ...
    for (channel = 0; channel < kNumChannels; channel++) {
      ...
      if (h0 > 0) {
        ...
        ngprvec[channel] = (int16_t) wl_WebRtcSpl_DivW32W16(tmp1_s32, h0);  // Q14
      ...
      if (h1 > 0) {
        ...
        sgprvec[channel] = (int16_t) wl_WebRtcSpl_DivW32W16(tmp1_s32, h1);  // Q14
    ...
    for (channel = 0; channel < kNumChannels; channel++) {
      ...
      for (k = 0; k < kNumGaussians; k++) {
        ...
        if (vadflag) {
          ...
          // 0.1 * Q20 / Q7 = Q13.
          if (tmp2_s32 > 0) {
            tmp_s16 = (int16_t) wl_WebRtcSpl_DivW32W16(tmp2_s32, ssk * 10);
          } else {
            tmp_s16 = (int16_t) wl_WebRtcSpl_DivW32W16(-tmp2_s32, ssk * 10);
            tmp_s16 = -tmp_s16;
          }
          ...
          // Q20 / Q7 = Q13.
          if (tmp1_s32 > 0) {
            tmp_s16 = (int16_t) wl_WebRtcSpl_DivW32W16(tmp1_s32, nsk);
          } else {
            tmp_s16 = (int16_t) wl_WebRtcSpl_DivW32W16(-tmp1_s32, nsk);
            tmp_s16 = -tmp_s16;
          }
