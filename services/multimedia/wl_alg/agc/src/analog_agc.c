...
void WebRtcAgc_UpdateAgcThresholds(Agc_t *stt)
{
    ...
    tmp16 = wl_WebRtcSpl_DivW32W16ResW16((int32_t)tmp16, ANALOG_TARGET_LEVEL);
...
static unsigned char agc_static[WEBRTC_AGC_BUFF_SIZE];
                   ...
                   int16_t agcMode, uint32_t fs)
{
    ...
    wl_WebRtcSpl_MemSetW32(stt->filterState, 0, 8);
