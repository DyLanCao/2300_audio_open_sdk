...
*/
    ...
    *aecmInst = aecm;
    ...
    TRACE("55555566666666");

    aecm->real_fft = wl_WebRtcSpl_CreateRealFFT(PART_LEN_SHIFT);
...
int16_t WebRtcAecm_CalcStepSize(AecmCore_t * const aecm)
{
    ...
    } else if (aecm->startupState > 0)
    {
        ...
        } else
        {
            ...
            tmp32 = wl_WebRtcSpl_DivW32W16(tmp32, aecm->farEnergyMaxMin);
    ...
    if (mu)
    {
        for (i = 0; i < PART_LEN1; i++)
        {
            ...
            if ((tmp32no1) && (far_spectrum[i] > (CHANNEL_VAD << far_q)))
            {
                ...
                tmp32no2 = wl_WebRtcSpl_DivW32W16(tmp32no2, i + 1);
    ...
    } else
    {
        ...
        if (dE < ENERGY_DEV_TOL)
        {
            ...
            if (dE < SUPGAIN_EPC_DT)
            {
                ...
                tmp16no1 = (int16_t)wl_WebRtcSpl_DivW32W16(tmp32no1, SUPGAIN_EPC_DT);
            ...
            } else
            {
                ...
                tmp16no1 = (int16_t)wl_WebRtcSpl_DivW32W16(tmp32no1, (ENERGY_DEV_TOL
                        - SUPGAIN_EPC_DT));
