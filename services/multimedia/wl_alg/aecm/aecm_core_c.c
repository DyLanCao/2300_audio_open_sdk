...
static void WindowAndFFT(AecmCore_t* aecm,
  ...
  wl_WebRtcSpl_RealForwardFFT(aecm->real_fft, fft, (int16_t*)freq_signal);
  for (i = 0; i < PART_LEN; i++) {
                                ...
                                const int16_t* nearendClean)
{
  ...
  outCFFT = wl_WebRtcSpl_RealInverseFFT(aecm->real_fft, fft, ifft_out);
  for (i = 0; i < PART_LEN; i++) {
                                 ...
                                 uint32_t* freq_signal_sum_abs)
{
  ...
  tmp16no1 = wl_WebRtcSpl_MaxAbsValueW16(time_signal, PART_LEN2);
  ...
  for (i = 1; i < PART_LEN; i++)
  {
    ...
    else
    {
      ...
      tmp32no1 = wl_WebRtcSpl_SqrtFloor(tmp32no2);
                            ...
                            int16_t * output)
{
  ...
  for (i = 0; i < PART_LEN1; i++)
  {
    ...
    } else
    {
      ...
      tmpU32 = wl_WebRtcSpl_DivU32U16(echoEst32Gained,
