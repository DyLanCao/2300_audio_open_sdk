...
int wl_WebRtcSpl_GetScalingSquare(int16_t* in_vector,
                               int in_vector_length,
                               int times);

// Copy and set operations. Implementation in copy_set_operations.c.
// Descriptions at bottom of file.
void wl_WebRtcSpl_MemSetW16(int16_t* vector,
                         int16_t set_value,
                         int vector_length);
void wl_WebRtcSpl_MemSetW32(int32_t* vector,
                         int32_t set_value,
                         int vector_length);
void wl_WebRtcSpl_MemCpyReversedOrder(int16_t* out_vector,
                                   int16_t* in_vector,
                                   int vector_length);
int16_t wl_WebRtcSpl_CopyFromEndW16(const int16_t* in_vector,
                                 int16_t in_vector_length,
                                 int16_t samples,
                                 int16_t* out_vector);
int16_t wl_WebRtcSpl_ZerosArrayW16(int16_t* vector,
                                int16_t vector_length);
int16_t wl_WebRtcSpl_ZerosArrayW32(int32_t* vector,
                                int16_t vector_length);
...
extern MaxAbsValueW16 wl_WebRtcSpl_MaxAbsValueW16;
int16_t wl_WebRtcSpl_MaxAbsValueW16C(const int16_t* vector, int length);
...
extern MaxAbsValueW32 wl_WebRtcSpl_MaxAbsValueW32;
int32_t wl_WebRtcSpl_MaxAbsValueW32C(const int32_t* vector, int length);
#if (defined WEBRTC_DETECT_ARM_NEON) || (defined WEBRTC_ARCH_ARM_NEON)
...
extern MaxValueW16 wl_WebRtcSpl_MaxValueW16;
int16_t wl_WebRtcSpl_MaxValueW16C(const int16_t* vector, int length);
#if (defined WEBRTC_DETECT_ARM_NEON) || (defined WEBRTC_ARCH_ARM_NEON)
...
extern MaxValueW32 wl_WebRtcSpl_MaxValueW32;
int32_t wl_WebRtcSpl_MaxValueW32C(const int32_t* vector, int length);
#if (defined WEBRTC_DETECT_ARM_NEON) || (defined WEBRTC_ARCH_ARM_NEON)
...
extern MinValueW16 wl_WebRtcSpl_MinValueW16;
int16_t wl_WebRtcSpl_MinValueW16C(const int16_t* vector, int length);
#if (defined WEBRTC_DETECT_ARM_NEON) || (defined WEBRTC_ARCH_ARM_NEON)
...
extern MinValueW32 wl_WebRtcSpl_MinValueW32;
int32_t wl_WebRtcSpl_MinValueW32C(const int32_t* vector, int length);
#if (defined WEBRTC_DETECT_ARM_NEON) || (defined WEBRTC_ARCH_ARM_NEON)
...
int wl_WebRtcSpl_MaxAbsIndexW16(const int16_t* vector, int length);
...
//                 or -1, if (vector == NULL || length <= 0).
int wl_WebRtcSpl_MaxIndexW16(const int16_t* vector, int length);
...
//                 indexes have the maximum, return the first);
//                 or -1, if (vector == NULL || length <= 0).
int wl_WebRtcSpl_MaxIndexW32(const int32_t* vector, int length);
...
//                 or -1, if (vector == NULL || length <= 0).
int wl_WebRtcSpl_MinIndexW16(const int16_t* vector, int length);
...
//                 indexes have the minimum, return the first);
//                 or -1, if (vector == NULL || length <= 0).
int wl_WebRtcSpl_MinIndexW32(const int32_t* vector, int length);
...
void wl_WebRtcSpl_VectorBitShiftW16(int16_t* out_vector,
                                 int16_t vector_length,
                                 const int16_t* in_vector,
                                 int16_t right_shifts);
void wl_WebRtcSpl_VectorBitShiftW32(int32_t* out_vector,
                                 int16_t vector_length,
                                 const int32_t* in_vector,
                                 int16_t right_shifts);
void wl_WebRtcSpl_VectorBitShiftW32ToW16(int16_t* out_vector,
                                      int vector_length,
                                      const int32_t* in_vector,
                                      int right_shifts);
void wl_WebRtcSpl_ScaleVector(const int16_t* in_vector,
                           int16_t* out_vector,
                           int16_t gain,
                           int16_t vector_length,
                           int16_t right_shifts);
void wl_WebRtcSpl_ScaleVectorWithSat(const int16_t* in_vector,
                                  int16_t* out_vector,
                                  int16_t gain,
                                  int16_t vector_length,
                                  int16_t right_shifts);
void wl_WebRtcSpl_ScaleAndAddVectors(const int16_t* in_vector1,
...
int wl_WebRtcSpl_ScaleAndAddVectorsWithRoundC(const int16_t* in_vector1,
                                           int16_t in_vector1_scale,
                                           const int16_t* in_vector2,
                                           int16_t in_vector2_scale,
                                           int right_shifts,
...
typedef void (*CrossCorrelation)(int32_t* cross_correlation,
                                 ...
                                 int16_t right_shifts,
                                 int16_t step_seq2);
extern CrossCorrelation wl_WebRtcSpl_CrossCorrelation;
void wl_WebRtcSpl_CrossCorrelationC(int32_t* cross_correlation,
                                 const int16_t* seq1,
                                 const int16_t* seq2,
                                 int16_t dim_seq,
                                 int16_t dim_cross_correlation,
...
int32_t wl_WebRtcSpl_SqrtFloor(int32_t value);

// Divisions. Implementations collected in division_operations.c and
// descriptions at bottom of this file.
uint32_t wl_WebRtcSpl_DivU32U16(uint32_t num, uint16_t den);
int32_t wl_WebRtcSpl_DivW32W16(int32_t num, int16_t den);
int16_t wl_WebRtcSpl_DivW32W16ResW16(int32_t num, int16_t den);
int32_t wl_WebRtcSpl_DivResultInQ31(int32_t num, int32_t den);
int32_t wl_WebRtcSpl_DivW32HiLow(int32_t num, int16_t den_hi, int16_t den_low);
// End: Divisions.

int32_t wl_WebRtcSpl_Energy(int16_t* vector, int vector_length, int* scale_factor);
...
typedef int (*DownsampleFast)(const int16_t* data_in,
                              ...
                              int factor,
                              int delay);
extern DownsampleFast wl_WebRtcSpl_DownsampleFast;
int wl_WebRtcSpl_DownsampleFastC(const int16_t* data_in,
                              int data_in_length,
                              int16_t* data_out,
                              int data_out_length,
                              const int16_t* __restrict coefficients,
...
void wl_WebRtcSpl_AnalysisQMF(const int16_t* in_data,
                           int16_t* low_band,
                           int16_t* high_band,
                           int32_t* filter_state1,
                           int32_t* filter_state2);
void wl_WebRtcSpl_SynthesisQMF(const int16_t* low_band,
