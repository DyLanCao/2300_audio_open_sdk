...
void wl_WebRtcSpl_VectorBitShiftW16(int16_t *res, int16_t length,
...
void wl_WebRtcSpl_VectorBitShiftW32ToW16(int16_t* out, int length,
...
void wl_WebRtcSpl_ScaleVector(const int16_t *in_vector, int16_t *out_vector,
...
void wl_WebRtcSpl_ScaleVectorWithSat(const int16_t *in_vector, int16_t *out_vector,
                                 int16_t gain, int16_t in_vector_length,
                                 int16_t right_shifts)
{
    // Performs vector operation: out_vector = (gain*in_vector)>>right_shifts
...
void wl_WebRtcSpl_ScaleAndAddVectors(const int16_t *in1, int16_t gain1, int shift1,
