...
static const char custom_stream_desc[] = "WL_StreamDataCharacteristic";
static const char custom_tx_desc[] = "WL_KeyCharacteristic";
static const char custom_rx_desc[] = "WL_CommandCharacteristic";
...
#ifdef  __APP_WL_SMARTVOICE__
    DATAPATHPS_IDX_RX_NTF_CFG,
    DATAPATHPS_IDX_STREAM_CHAR,
    DATAPATHPS_IDX_STREAM_VAL,
    DATAPATHPS_IDX_STREAM_NTF_CFG,
    DATAPATHPS_IDX_STREAM_DESC,
#endif
    DATAPATHPS_IDX_NB,
};
...
#ifdef  __APP_WL_SMARTVOICE__
    uint8_t     isStreamNotificationEnabled[BLE_CONNECTION_MAX];
    uint8_t     isRxNotificationEnabled[BLE_CONNECTION_MAX];
#endif
