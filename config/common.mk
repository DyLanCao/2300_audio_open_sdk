...
export GCC_PHAT_FIXED ?= 0
ifeq ($(GCC_PHAT_FIXED),1)
KBUILD_CPPFLAGS += -DGCC_PHAT_FIXED
endif
...
export STEREO_MIC ?=0
ifeq ($(STEREO_MIC),1)
KBUILD_CPPFLAGS += -DSTEREO_MIC
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 2
endif


export DUAL_MIC_NSX ?=0
ifeq ($(DUAL_MIC_NSX),1)
KBUILD_CPPFLAGS += -DDUAL_MIC_NSX
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 2
endif
