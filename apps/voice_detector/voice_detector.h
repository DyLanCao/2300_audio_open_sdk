...
#define VAD_FIND                           (1 << 25)
#define VAD_NOT_FIND                    (1 << 26)
...
enum voice_detector_cmd {
    ...
    VOICE_DET_CMD_AUD_AON_CLK_EN,
    VOICE_DET_CMD_AUD_AON_CLK_DIS,
...
enum voice_detector_state {
    ...
    VOICE_DET_STATE_AUD_AON_CLK_EN  = VOICE_DET_CMD_AUD_AON_CLK_EN,
    VOICE_DET_STATE_AUD_AON_CLK_DIS = VOICE_DET_CMD_AUD_AON_CLK_DIS,
 ...
 * return: 0(success) !0(fail)
 */
int voice_detector_setup_vad(enum voice_detector_id id, struct codec_vad_conf *conf);
